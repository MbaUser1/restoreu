...
type Role = "administrateur" | "utilisateur";

interface ApartProps {
  role: Role;
}

const SignUp: React.FC<ApartProps> = ({ role }) => {
  console.log(role);
  ...
  async function onSubmit(data: RegisterFormData) {
    try {
      ...
      const response = await fetch(`${baseUrl}/api/utilisateurs`, {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        if (response.status === 409) {
          setEmailErr("Un utilisateur avec cette adresse email existe déjà");
  ...
  return (
    <div className="md:h-500 m-10 rounded-sm border border-stroke bg-white shadow-default dark:bg-boxdark md:m-50">
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 py-17.5 text-center">
            ...
            <p className="2xl:px-20">
              Retrouvez vos pieces perdues grace a RestoreU
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    type="text"
                    placeholder="Entrez votre nom conplet"
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  <small className="text-sm text-rose-600 ">{emailErr}</small>
                  <span className="absolute right-4 top-4">
                    <FontAwesomeIcon
                      icon={faEnvelope}
                      width="22"
